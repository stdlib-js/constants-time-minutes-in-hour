...
```javascript
MINUTES_IN_HOUR = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-minutes-in-hour@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-minutes-in-hour@umd/bundle.js"></script>
```
