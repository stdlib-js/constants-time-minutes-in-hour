...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/constants-time-minutes-in-hour/tags). For example,

```javascript
MINUTES_IN_HOUR = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-minutes-in-hour@v0.3.0-umd/browser.js' )
```
